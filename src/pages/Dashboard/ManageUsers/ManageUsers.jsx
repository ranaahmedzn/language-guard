                            ...
                            users.map((user, index) => <tr
                                ...
                                <td className="px-6 py-4">
                                    <div className="flex items-center gap-3">
                                        <button onClick={() => handleMakeInstructor(user._id)} className="bg-yellow-100 text-yellow-600 text-sm font-medium px-4 py-2 rounded inline-flex gap-2 items-center" >
                                            Make Instructor
                                        </button>
                                        <button onClick={() => handleMakeAdmin(user._id)} className="bg-green-100 text-green-600 text-sm font-medium px-4 py-2 rounded inline-flex gap-2 items-center">
                                            Make Admin
                                        </button>
                                    </div>
                                </td>
