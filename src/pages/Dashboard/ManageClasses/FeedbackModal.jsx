                ...
                <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div className="px-6 py-6 lg:px-8">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="mb-3">
                                <textarea id="message" {...register("message")} name="message" rows="4" className="py-2 px-3 block w-full rounded-md text-sm focus:ring-[#FEBC1E] focus:border-transparent bg-gray-200 text-gray-600"></textarea>
                            </div>
